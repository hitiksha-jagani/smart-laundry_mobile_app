...
const TodayDeliveryCard = ({ delivery }) => {
    ...
    useEffect(() => {
        ...
        setAgentLocation(location.coords);
        };
    ...
    const handleUpdateStatus = () => {
        navigation.navigate('UpdateStatus', { delivery });
    };
        ...
        <>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.contactBox}>
                    ...
                    <Text style={styles.contactTitle}>Order ID</Text>
                ...
                <TouchableOpacity style={styles.routeBtn} onPress={handleUpdateStatus}>
                    <Text style={styles.routeText}>Update Status</Text>
                </TouchableOpacity>
