        ...
        <DeliveryAgentLayout> 
          ...
          <View style={[styles.container, deliveryAgentStyles.deliveryAgentBody]}>
            ...
            <View style={deliveryAgentStyles.container}>
              ...
              <Text style={[deliveryAgentStyles.h1Agent, styles.heading]}>Total Payouts</Text>
                ...
                data.map((entry, idx) => (
                      ...
                      <View key={idx} style={styles.contactBox}>
                        ...
                        <View style={styles.itemCardRow}>
                          ...
                          <Text style={styles.itemLabel}>Payout Status:</Text>
                          <Text style={styles.itemValue}>{entry.payoutStatus}</Text>
