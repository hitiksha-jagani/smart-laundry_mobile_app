...
const linking = {
  ...
  config: {
    screens: {
      ...
      ProviderDrawer: '/provider/drawer',
      DeliveredOrders: '/provider/completed-orders',
      ServiceProviderProfileForm: '/provider/complete-profile',
      EditServiceProviderProfile: '/provider/edit-profile',
      VerifyPickupOtp: 'provider/otp/pickup/:orderId',
      VerifyDeliveryOtp: 'provider/otp/delivery/:orderId',
      RazorpayPaymentScreen: '/payment/razorpay',
      DeliveryAgentCompleteProfile: '/delivery/complete-profile',
      DeliveryPage: '/delivery/summary',
      PendingDeliveries: '/delivery/pending',
      TodayDeliveries: '/delivery/today',
      UpdateStatus: '/delivery/update-status',
      AvailabilityScreen: '/delivery/availability',
      DeliveryAgentPayout: '/payouts/summary',
      AllPayouts: '/payouts/all',
      PaidPayouts: '/payouts/paid',
      PendingPayouts: '/payouts/pending',
      DeliveryAgentProfile: '/delivery/profile',
      EditAgentProfile: '/delivery/profile/edit',
      ChangeAgentPasswordPage: '/delivery/profile/change-password',
      NotAvailable: '/not-available',
      NotFound: '*',
    },
  },
    ...
    <AuthProvider>
      <NavigationContainer linking={linking} fallback={<NotFoundScreen />}>
        <Stack.Navigator initialRouteName="AutoRedirect" screenOptions={{ headerShown: false }}>
          ...
          <Stack.Screen name="NotAvailableInThisVersion" component={NotAvailablePage} />
